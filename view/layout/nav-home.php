...
<nav id="sidenav">
    ...
    <div class="giris-wrapper">
        <?php if(isset($_SESSION['k_id'])) { ?>
            ...
            <a href="#" id="open-modal" class="kalin">Giriş</a> <?php
        } ?>
    </div>
...
<div id="modal">
    <div class="modal-content">
        ...
        <form action="index.php?section=home&action=login" method="post" class="modal-form">
            ...
            <input type="text" name="k_adi" class="form-item" placeholder="Kullanıcı adınızı girin" required>
            

            <div class="form-item kalin">Şifre</div>            
            <input type="password" name="sifre" class="form-item" placeholder="Şifrenizi adınızı girin" required>   
            
            <input type="submit" value="Giriş" name=giris class="form-item submit-btn kalin">
