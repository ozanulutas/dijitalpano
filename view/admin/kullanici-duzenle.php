...
<div class="form-wrapper">
    ...
    <form action="index.php?section=kullanici&action=delete" method="post">
        ...
        <div class="btn-sil-wrapper">
            <button type="submit" name="sil" class="btn-sil" onclick="return deleteControl('Hesabınızı silmek istediğinize emin misiniz?');">Hesabı Sil</button>
        </div> 
    ...
    <form action="index.php?section=kullanici&action=<?php echo $data['action']; ?>" method="post" class="form">
        ...
        <input type="text" name="k_adi" value="<?php echo $data['kullanici']->k_adi ?? ''; ?>" placeholder="Kullanıcı Adınız" class="form-item" required> <br>
